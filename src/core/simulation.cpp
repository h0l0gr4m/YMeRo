...
void Simulation::assemble()
{
    ...
    auto task_localNeuralNetwork                  = scheduler->createTask("Local NeuralNetwork");
    auto task_haloNeuralNetwork                   = scheduler->createTask("Halo NeuralNetwork");
    ...
    //Computation between interaction ?! ------------------------------------------------------------------------------------------------------------------
