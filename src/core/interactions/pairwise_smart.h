...
public:
    ...
    InteractionPairSmart(std::string name, std::string parameterName,float a, float gamma,  float rc, PairwiseInteraction pair) :
        Interaction(name, rc),parameterName(parameterName),a(a),gamma(gamma) ,defaultPair(pair)
    { }
