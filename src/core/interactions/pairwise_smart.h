...
public:
    ...
    InteractionPairSmart(const YmrState *state,std::string name, std::string parameterName,std::vector<float> weights,float a, float gamma,  float rc, PairwiseInteraction pair) :
