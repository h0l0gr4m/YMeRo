...
{
public:
    InteractionSmartDPDWithStress(const YmrState *state,std::string name,std::string parameterName, std::string stressName, float rc, float a, float gamma, float kbt,float power, float stressPeriod);
