...
public:
    ...
    InteractionSmartDPD(std::string name, float rc, float a, float gamma, float kbt, float dt, float power);
...
protected:
    ...
    InteractionSmartDPD(std::string name, float rc, float a, float gamma, float kbt, float dt, float power, bool allocateImpl);
